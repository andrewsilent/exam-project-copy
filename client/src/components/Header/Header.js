                            ...
                            <ul>
                                <li>
                                    <span>NAME IDEAS</span><img src={`${CONSTANTS.STATIC_IMAGES_PATH}menu-down.png`}
                                                                alt='menu'/>
                                    <ul>
                                        <li><a target="_blank" href="http://www.google.com">Consulting</a></li>
                                        <li><a target="_blank" href="http://www.google.com">Beauty</a></li>
                                        <li><a target="_blank" href="http://www.google.com">E-Commerce</a></li>
                                        <li><a target="_blank" href="http://www.google.com">Fashion & Clothing</a></li>
                                ...
                                <li>
                                    ...
                                    <img src={`${CONSTANTS.STATIC_IMAGES_PATH}menu-down.png`} alt='menu'/>
                                    <ul>
                                        <li><a target="_blank" href="http://www.google.com">POPULAR NAMES</a></li>
                                        <li><a target="_blank" href="http://www.google.com">SHORT NAMES</a></li>
